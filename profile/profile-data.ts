  ...
  "techstack":[
    {
      category: "Languages",
      items: [
        { name: "Javascript", image: "/icons/Javascript-min.png" },
        { name: "Typescript", image: "/icons/Typescript-min.png" },
        { name: "Python", image: "/icons/Python-min.png" },
      ],
    },
    {
      category: "Web Technologies",
      items: [
        { name: "HTML", image: "/icons/HTML-min.png" },
        { name: "CSS", image: "/icons/CSS-min.png" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Apollo", image: "/icons/Apollo-min.png" },
    ...
    },
    {
      ...
      items: [
        { name: "Git", image: "/icons/Git-min.png" },
        { name: "Vercel", image: "/icons/Vercel-min.svg" },
        { name: "Photoshop", image: "/icons/Photoshop-min.svg" },
        { name: "Illustrator", image: "/icons/Illustrator-min.svg" },
      ],
    },
  ],
  "skills" : [
